...
if __name__ == '__main__':
    ...
    '''❯ pip3 install .
Processing /PycharmProjects/4a_binomial_package
Building wheels for collected packages: distributions
  Building wheel for distributions (setup.py) ... done
  Created wheel for distributions: filename=distributions-0.1-py3-none-any.whl size=6395 sha256=6abcc7c69e572058c3f4a3fe4e38792ccb9fa8a791e210f238e73c8c136fcfe7
  Stored in directory: /private/var/folders/m9/_3z7r_zs60lg6wvnfc81r_dh0000gp/T/pip-ephem-wheel-cache-uyxnc7az/wheels/a0/89/fc/e290dd435513ad1a755632a08f644a676d00357d70031b19b8
Successfully built distributions
Installing collected packages: distributions
  Attempting uninstall: distributions
    Found existing installation: distributions 0.1
    Uninstalling distributions-0.1:
      Successfully uninstalled distributions-0.1
